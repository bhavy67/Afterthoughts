  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 md:px-20">
      ...
      <div className="pt-10 pb-8">
        <Link href="/shelf" style={{ fontFamily: "'DM Mono', monospace", fontSize: '11px', letterSpacing: '0.12em', color: '#B8B2AA', textDecoration: 'none' }}>
          ← shelf
        </Link>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-10 md:gap-16 pb-16">
        ...
        <div className="shrink-0" style={{ width: '160px' }}>
          <div style={{ width: '160px', height: '240px', backgroundColor: '#EEECEA', border: '1px solid rgba(26,26,26,0.07)', display: 'flex', alignItems: 'flex-end', padding: '10px' }}>
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: '9px', color: '#C8C2BA', lineHeight: 1.4 }}>{book.title}</span>
          </div>
        </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: '11px', letterSpacing: '0.12em', color: '#C0503A' }}>novel</span>
            <span style={{ width: '3px', height: '3px', borderRadius: '50%', backgroundColor: '#C8C2BA', display: 'inline-block' }} />
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: '11px', color: '#C8C2BA' }}>{book.year}</span>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px', marginBottom: '32px' }}>
            ...
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: '12px', color: '#B8B2AA' }}>{book.rating.toFixed(1)}</span>
          </div>
          ...
          {/* Favorite quote */}
          {book.favoriteQuote && (
            <blockquote style={{ borderLeft: '2px solid rgba(192,80,58,0.3)', paddingLeft: '20px', marginBottom: '24px' }}>
              <p style={{ fontFamily: "'Fraunces Variable', 'Fraunces', serif", fontStyle: 'italic', fontWeight: 300, fontSize: '17px', lineHeight: 1.6, color: '#6E6860' }}>
